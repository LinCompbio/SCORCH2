...
Download the prepared features (DUD-E, DEKOIS, VSDS-VD, MERCK FEP benchmark), model weight, and normalizers for two XGBoost models from [Zenodo](https://zenodo.org/records/14994007). Unzip the files to the root repository. Then run one of the scripts below:
